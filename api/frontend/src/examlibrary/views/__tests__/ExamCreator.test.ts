...
describe('ExamCreator', () => {
  ...
  it('creates and returns a new exam object on form fill and submission', async () => {
    ...
    const essayPossiblePointsInput = wrapper.find('#essay-possible-points-input')

    await essayQuestionTextInput.setValue('Discuss the impacts of climate change.')
    ...
    // Assert
    expect(newExamOutput.text()).toContain('Discuss the impacts of climate change.')
