...
<template>
  <div class="card w-full bg-base-300 shadow-md card-border border-secondary border-solid">
    <div class="card-body">
      <div class="card-title">Ping Pong Lookup</div>
      <label class="input">
        <input id="pingpong-lookup" type="text" class="grow" placeholder="pingpong id" v-model="lookupInput" />
      </label>
      <div class="card-actions">
        <div id="lookup-button" class="btn btn-m text-xs" @click="clickLookup(lookupInput)">Lookup</div>
      </div>
      ...
      <div v-else-if="error">
        <div id="pingpong-lookup-error" class="card w-full card-border border-secondary border-solid">
          <div class="card-body">
            <div class="overflow-x-auto rounded-box border border-base-content/5 bg-base-100">
