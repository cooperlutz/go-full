...
<template>
  <div class="card w-full bg-base-300 shadow-md card-border border-secondary border-solid">
    <div class="card-body">
      ...
      <label class="input">
        <input id="pingpong-input" type="text" class="grow" placeholder="ping or pong" v-model="inputValue" />
      </label>
      <div class="card-actions">
        <div id="send-button" class="btn btn-m text-xs" @click="clickSend(inputValue)">Send</div>
      </div>
    </div>
  </div>
</template>
