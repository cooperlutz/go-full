...
export interface MetricsApiInterface {
     ...
     */
    getDailyDistributionRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Trend>>;
...
export class MetricsApi extends runtime.BaseAPI implements MetricsApiInterface {
     ...
     * Get total number of ping pongs per day
     */
    async getDailyDistributionRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Trend>> {
     ...
     * Get total number of Pings Pongs
     */
    async getTotalPingPongsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<number>> {
        const queryParameters: any = {};
     ...
     * Get total number of Pings
     */
    async getTotalPingsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<number>> {
        const queryParameters: any = {};
     ...
     * Get total number of Pongs
     */
    async getTotalPongsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<number>> {
        const queryParameters: any = {};
