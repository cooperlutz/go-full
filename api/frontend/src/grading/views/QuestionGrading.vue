...
import { useGetExamQuestion, useGradeExamQuestion } from '../composables/useGrading'
...
function gradeQuestion() {
  gradeExamQuestion(examId, questionIndex, pointsToGive.value, graderComments.value)
      ...
      <div class="grid grid-cols-2">
        ...
        <div class="col-span-1">
          <form class="fieldset">
            ...
            <button class="btn btn-primary" @click="gradeQuestion" id="save-feedback-and-points">Save</button>
          </form>
        </div>
      </div>
    </div>
