...
const { incompleteExams, loading, error, getFindIncompleteExams } = useGetFindIncompleteExams()
...
<template>
  <div id="exams-to-grade">
    ...
    <div v-else-if="!loading && !error && incompleteExams != null && incompleteExams.length > 0">
