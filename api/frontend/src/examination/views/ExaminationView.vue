...
<template>
  ...
  <card v-if="exam" class="w-96 bg-base-100 shadow-xl" id="examination-view-component">
    <div class="card-body">
      <div class="grid grid-cols-5 gap-4 mb-4">
        ...
        <div class="col-span-1">
          <QuestionNav v-if="exam.questions" :examId="exam.examId" :questions="exam.questions" />
