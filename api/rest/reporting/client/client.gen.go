...
func (c *Client) GetMetric(ctx context.Context, metricName string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetMetricRequest(c.Server, metricName)
	if err != nil {
		return nil, err
	}
...
func NewGetMetricRequest(server string, metricName string) (*http.Request, error) {
	var err error

	var pathParam0 string

	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "metricName", metricName, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
	if err != nil {
		return nil, err
	}
	...
	operationPath := fmt.Sprintf("/v1/metrics/%s", pathParam0)
	if operationPath[0] == '/' {
...
func (c *ClientWithResponses) GetMetricWithResponse(ctx context.Context, metricName string, reqEditors ...RequestEditorFn) (*GetMetricResponse, error) {
	rsp, err := c.GetMetric(ctx, metricName, reqEditors...)
	if err != nil {
		return nil, err
	}
