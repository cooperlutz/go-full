...
![Business Model Canvas](./_templates/business_model_canvas.drawio.png)

## Discover

Discover the domain visually and collaboratively.

![Domain Story](./_templates/domain_story_canvas.drawio.png)
...
![Domain Message Flow Modelling](./_templates/domain_message_flow_modelling.drawio.png)

## Organise

Organise autonomous teams that are optimised for fast flow and aligned with context boundaries.

![Context Mapping](./_templates/context_mapping.drawio.png)

## Define

Define the roles and responsibilities of each [bounded context](https://martinfowler.com/bliki/BoundedContext.html).

![Bounded Context Canvas](./_templates/bounded_context_canvas.drawio.png)

## Code

Code the domain model.

![Aggregate Design Canvas](./_templates/aggregate_design_canvas_v1.1.drawio.svg)
