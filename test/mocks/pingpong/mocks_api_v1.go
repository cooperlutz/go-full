...
// GetFindOneByID provides a mock function for the type MockServerInterface
func (_mock *MockServerInterface) GetFindOneByID(w http.ResponseWriter, r *http.Request, pingPongID types.UUID) {
	_mock.Called(w, r, pingPongID)
	return
}

// MockServerInterface_GetFindOneByID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetFindOneByID'
type MockServerInterface_GetFindOneByID_Call struct {
	*mock.Call
}

// GetFindOneByID is a helper method to define mock.On call
//   - w http.ResponseWriter
//   - r *http.Request
//   - pingPongID types.UUID
func (_e *MockServerInterface_Expecter) GetFindOneByID(w interface{}, r interface{}, pingPongID interface{}) *MockServerInterface_GetFindOneByID_Call {
	return &MockServerInterface_GetFindOneByID_Call{Call: _e.mock.On("GetFindOneByID", w, r, pingPongID)}
}

func (_c *MockServerInterface_GetFindOneByID_Call) Run(run func(w http.ResponseWriter, r *http.Request, pingPongID types.UUID)) *MockServerInterface_GetFindOneByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 http.ResponseWriter
		if args[0] != nil {
			arg0 = args[0].(http.ResponseWriter)
...
func (_c *MockServerInterface_GetFindOneByID_Call) Return() *MockServerInterface_GetFindOneByID_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockServerInterface_GetFindOneByID_Call) RunAndReturn(run func(w http.ResponseWriter, r *http.Request, pingPongID types.UUID)) *MockServerInterface_GetFindOneByID_Call {
	_c.Run(run)
	return _c
}
...
// NewMockGetFindOneByIDResponseObject creates a new instance of MockGetFindOneByIDResponseObject. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockGetFindOneByIDResponseObject(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockGetFindOneByIDResponseObject {
	mock := &MockGetFindOneByIDResponseObject{}
	mock.Mock.Test(t)
...
// MockGetFindOneByIDResponseObject is an autogenerated mock type for the GetFindOneByIDResponseObject type
type MockGetFindOneByIDResponseObject struct {
	mock.Mock
}

type MockGetFindOneByIDResponseObject_Expecter struct {
	mock *mock.Mock
}

func (_m *MockGetFindOneByIDResponseObject) EXPECT() *MockGetFindOneByIDResponseObject_Expecter {
	return &MockGetFindOneByIDResponseObject_Expecter{mock: &_m.Mock}
}

// VisitGetFindOneByIDResponse provides a mock function for the type MockGetFindOneByIDResponseObject
func (_mock *MockGetFindOneByIDResponseObject) VisitGetFindOneByIDResponse(w http.ResponseWriter) error {
	ret := _mock.Called(w)

	if len(ret) == 0 {
		panic("no return value specified for VisitGetFindOneByIDResponse")
	}
...
// MockGetFindOneByIDResponseObject_VisitGetFindOneByIDResponse_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'VisitGetFindOneByIDResponse'
type MockGetFindOneByIDResponseObject_VisitGetFindOneByIDResponse_Call struct {
	*mock.Call
}

// VisitGetFindOneByIDResponse is a helper method to define mock.On call
//   - w http.ResponseWriter
func (_e *MockGetFindOneByIDResponseObject_Expecter) VisitGetFindOneByIDResponse(w interface{}) *MockGetFindOneByIDResponseObject_VisitGetFindOneByIDResponse_Call {
	return &MockGetFindOneByIDResponseObject_VisitGetFindOneByIDResponse_Call{Call: _e.mock.On("VisitGetFindOneByIDResponse", w)}
}

func (_c *MockGetFindOneByIDResponseObject_VisitGetFindOneByIDResponse_Call) Run(run func(w http.ResponseWriter)) *MockGetFindOneByIDResponseObject_VisitGetFindOneByIDResponse_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 http.ResponseWriter
		if args[0] != nil {
			arg0 = args[0].(http.ResponseWriter)
...
func (_c *MockGetFindOneByIDResponseObject_VisitGetFindOneByIDResponse_Call) Return(err error) *MockGetFindOneByIDResponseObject_VisitGetFindOneByIDResponse_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockGetFindOneByIDResponseObject_VisitGetFindOneByIDResponse_Call) RunAndReturn(run func(w http.ResponseWriter) error) *MockGetFindOneByIDResponseObject_VisitGetFindOneByIDResponse_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetFindOneByID provides a mock function for the type MockStrictServerInterface
func (_mock *MockStrictServerInterface) GetFindOneByID(ctx context.Context, request server.GetFindOneByIDRequestObject) (server.GetFindOneByIDResponseObject, error) {
	ret := _mock.Called(ctx, request)

	if len(ret) == 0 {
		panic("no return value specified for GetFindOneByID")
	}

	var r0 server.GetFindOneByIDResponseObject
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, server.GetFindOneByIDRequestObject) (server.GetFindOneByIDResponseObject, error)); ok {
		return returnFunc(ctx, request)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, server.GetFindOneByIDRequestObject) server.GetFindOneByIDResponseObject); ok {
		r0 = returnFunc(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(server.GetFindOneByIDResponseObject)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, server.GetFindOneByIDRequestObject) error); ok {
		r1 = returnFunc(ctx, request)
	} else {
		r1 = ret.Error(1)
	}
...
// MockStrictServerInterface_GetFindOneByID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetFindOneByID'
type MockStrictServerInterface_GetFindOneByID_Call struct {
	*mock.Call
}

// GetFindOneByID is a helper method to define mock.On call
//   - ctx context.Context
//   - request server.GetFindOneByIDRequestObject
func (_e *MockStrictServerInterface_Expecter) GetFindOneByID(ctx interface{}, request interface{}) *MockStrictServerInterface_GetFindOneByID_Call {
	return &MockStrictServerInterface_GetFindOneByID_Call{Call: _e.mock.On("GetFindOneByID", ctx, request)}
}

func (_c *MockStrictServerInterface_GetFindOneByID_Call) Run(run func(ctx context.Context, request server.GetFindOneByIDRequestObject)) *MockStrictServerInterface_GetFindOneByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 server.GetFindOneByIDRequestObject
		if args[1] != nil {
			arg1 = args[1].(server.GetFindOneByIDRequestObject)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockStrictServerInterface_GetFindOneByID_Call) Return(getFindOneByIDResponseObject server.GetFindOneByIDResponseObject, err error) *MockStrictServerInterface_GetFindOneByID_Call {
	_c.Call.Return(getFindOneByIDResponseObject, err)
	return _c
}

func (_c *MockStrictServerInterface_GetFindOneByID_Call) RunAndReturn(run func(ctx context.Context, request server.GetFindOneByIDRequestObject) (server.GetFindOneByIDResponseObject, error)) *MockStrictServerInterface_GetFindOneByID_Call {
	_c.Call.Return(run)
	return _c
}
