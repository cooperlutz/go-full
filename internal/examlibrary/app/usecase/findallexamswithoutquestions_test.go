...
func TestFindAllExamsWithoutQuestions(t *testing.T) {
	// Arrange
	...
	// Act
	result, err := useCase.FindAllExamsWithoutQuestions(
		ctx,
...
func TestFindAllExamsWithoutQuestions_FailurePersist(t *testing.T) {
	// Arrange
	ctx := context.Background()
	mockRepo := mocks.NewMockIExamLibraryRepository(t)
	mockPubSub := mocks.NewMockIPubSubEventProcessor(t)
