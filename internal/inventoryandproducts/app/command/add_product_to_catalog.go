...
type AddProductToCatalog struct {
	//
	//Name string,
	//
	//Description *string,
...
type AddProductToCatalogHandler struct {
...
func NewAddProductToCatalogHandler(
	productRepo inventoryandproducts.ProductRepository,
	...
	return AddProductToCatalogHandler{
...
func (h AddProductToCatalogHandler) Handle(ctx context.Context, cmd AddProductToCatalog) error {
	// ctx, span := telemetree.AddSpan(ctx, "inventoryandproducts.app.command.add_product_to_catalog.handle")
	// defer span.End()
