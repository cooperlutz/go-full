...
var (
	Available         = Availability{"available"}          //nolint:gochecknoglobals // enum values are allowed as globals
	NotAvailable      = Availability{"not_available"}      //nolint:gochecknoglobals // enum values are allowed as globals
	TrainingScheduled = Availability{"training_scheduled"} //nolint:gochecknoglobals // enum values are allowed as globals
)

var availabilityValues = []Availability{ //nolint:gochecknoglobals // enum values are allowed as globals
	Available,
	NotAvailable,
	TrainingScheduled,
}
